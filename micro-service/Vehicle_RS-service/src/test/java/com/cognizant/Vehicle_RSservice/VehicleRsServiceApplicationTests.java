...
import com.cognizant.Vehicle_RSservice.repository.BookingRepository;
import com.cognizant.Vehicle_RSservice.repository.UserRepository;
import com.cognizant.Vehicle_RSservice.repository.VehicleRepository;
import com.cognizant.Vehicle_RSservice.service.BookingService;
import com.cognizant.Vehicle_RSservice.service.VehicleService;



@SpringBootTest
class VehicleRsServiceApplicationTests {
	...
	public void addVehicleTest(){
		...
		Vehicle vehicle= new Vehicle(100, "Merc AMG", "hello", "ASDFGHJK","2", "petrol", 356, true, "NG", new Date(2019, 02, 02), new Date(2019, 02, 02), new Date(2019, 02, 02), false);
	...
	public void aamodifyVehicleTest(){
		...
		assertEquals(vehicle2.getBranch(),"NG");
	...
	public void addNewBookingTest(){
		...
		bookingService.addVehicleToBooking("jojo", 3, booking);
		User user= userRepository.findByUsername("jojo");
	...
	public void cancelBookingTest(){
		User user= userRepository.findByUsername("jojo");
		Booking booking1= user.getBooking();
		bookingService.CancelBooking("jojo", 3);
